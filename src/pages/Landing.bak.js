...
import img from "../assets/atsimevu.jpg"
  ...
  return (
    <>
      ...
      <main>
        ...
        >
          <BkgdImg className="absolute top-0 w-full h-full bg-center bg-cover">
          ...
          <div className="container relative mx-auto">
            <div className="flex flex-wrap items-center">
              <div className="w-full px-4 ml-auto mr-auto text-center lg:w-6/12">
                <div className="pr-12">
                  <img src={title} alt={"TamTamFam title"} />
                  <p className="mt-4 text-lg text-gray-300">
                    An online place for people in the dance and drumming community.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="pb-20 -mt-24 bg-orange-300">
            ...
            <div className="flex flex-wrap">
              <div className="w-full px-4 mb-12 md:w-6/12 lg:w-3/12 lg:mb-0">
                <div className="px-6">
                  <img
                    alt="..."
                    src={"https://placeimg.com/800/800/any"}
        ...
        <section className="relative block py-24 bg-gray-900 lg:pt-0">
          <div className="container px-4 mx-auto">
            <div className="flex flex-wrap justify-center -mt-48 lg:-mt-64">
              <div className="w-full px-4 lg:w-6/12">
                <div className="relative flex flex-col w-full min-w-0 mb-6 break-words bg-orange-300 rounded-lg shadow-lg">
